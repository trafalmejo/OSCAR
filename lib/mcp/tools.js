...
const HOWTO =
  ...
  "drags in absolute mode, and a part without it is pulled out of the layout when touched (create_surface adds it " +
  "where missing). Validate with validate_surface until ok, then create_surface " +
