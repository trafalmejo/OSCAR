 ...
 *     //    (see public/src/oscar_editor.js).
 ...
 *
 * This file touches no network and no disk beyond require(); server.js hands
 * it the app. That keeps it testable with plain objects.
 */
...
function createExtensions(loaded, log) {
  ...
  return {
     ...
     *                           onState(fn) to follow it. See lib/surfaces.js
...
module.exports = { API, OPTIONAL, extensionIds, loadExtensions, complaintAbout, none };
