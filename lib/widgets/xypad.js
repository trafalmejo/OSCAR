 ...
 * while a finger is dragging it. On DMX, X lands on the first channel of the
 * block and Y on the next: pan and tilt on a moving head.
 */
const xypad = {
  name: "oscar-xypad",
  tag: "div",
  ...
  attach: function (el, ctx) {
     ...
     * view-only path -- a value that came in must never go back out.
     */
