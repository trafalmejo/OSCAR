...
function validate(definition) {
  ...
  if (!definition.block || typeof definition.block.label !== "string") problems.push("block.label");
  if (!definition.defaults || typeof definition.defaults !== "object") problems.push("defaults");
