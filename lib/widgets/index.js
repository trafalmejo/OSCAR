 ...
 * is delivering an incoming message. A widget applies what it hears to its
 * element and stores it with set(), and that is the whole of its job. A hand
 * on a control outranks the network: while a widget is being dragged or held
 * it ignores what arrives. A display-only widget (a meter) sets sends: false,
 * receives: true, and does nothing but follow().
 *
