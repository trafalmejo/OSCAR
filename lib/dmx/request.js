...
const { SLOTS, MAX_LEVEL, protocol, HOST, readHost, readTarget } = require("./spec");
...
function buildRequest(input) {
  ...
  // A node's address on the network; a port's name on USB.
  const host = readTarget(spec.id, input.host);
