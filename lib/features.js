...
const DEFAULTS = {
   ...
   *
   * On since 2026-09-25: the panel, and OSC's Via choice (network or the
   * cable), are offered. Still to be tried on real boards -- an Uno or Nano
   * over USB, both directions -- before 2.1 ships; the to-do list has it.
   * A board with Wi-Fi or Ethernet never needed any of this.
   */
  SERIAL: true,
